                    ...
                    >
                        ...
                        >
                            ...
                            <div className='flex gap-4'>
                                <button className='flex-1 border rounded-xl py-2' onClick={() => setShowApprovalModal(false)}>Cancel</button>
                ...
                {showRejectionModal && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='flex gap-4'>
                                <button className='flex-1 border rounded-xl py-2' onClick={() => setShowRejectionModal(false)}>Cancel</button>
