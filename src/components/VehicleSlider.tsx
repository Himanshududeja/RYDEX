...
import { CarTaxiFront, Bike, Car, Bus, Truck, ChevronLeft, ChevronRight, Sparkles } from 'lucide-react'
...
const VEHICLE_CATEGORIES = [
  ...
  { title: "Vans", desc: "Family and group travel", Icon: Bus, tag: "Group" },
  { title: "Trucks", desc: "Heavy and commercial transport", Icon: Truck, tag: "Cargo" },
];
function VehicleSlider() {
  ...
  useEffect(() => {
    // ensure hydration matches server output before layout effects/animations kick in
            ...
            <h2 className='text-3xl sm:text-4xl font-black tracking-tight text-zinc-900 leading-none'>
              ...
              <span className='relative inline-block'>Categories
                <motion.div
                  ...
                  transition={{ duration: 0.6, delay: 0.4, ease: [0.22, 1, 0.35, 1] }}
                ...
                return(
                  ...
                  >
                    ...
                    >
                      <motion.div
                        animate={{
                          backgroundColor: isHovered ? "rgba(255,255,0,0.12)" : "#f4f4f5",
                          color: isHovered ? "#ffffff" : "#71717a",
                          borderColor: isHovered ? "rgba(255,255,0,0.15)" : "#e4e4e7",
                        }}
